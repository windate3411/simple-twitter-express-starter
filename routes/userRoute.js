...
router.get('/:id/followings', ensureAuthenticated, getUser, userController.getFollowings)
router.get('/:id/followers', ensureAuthenticated, getUser, userController.getFollowers)
